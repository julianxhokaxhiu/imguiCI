...
vcpkg install "imgui:${env:_LIBPNG_TRIPLETNAME}" --recurse
vcpkg export "imgui:${env:_LIBPNG_TRIPLETNAME}" --output="${env:_RELEASE_NAME}-${env:_RELEASE_VERSION}_${env:_RELEASE_CONFIGURATION}" --zip
